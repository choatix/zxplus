...
public class Version {
    public static final int VERSION = 401; // Increment by 1 for new version. Updated for 5.1.0-SC.
    public static final String VERSION_STRING = "5.1.0-SC";
